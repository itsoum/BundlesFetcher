...
data = [1./dato if dato!=0 else dato for dato in data]
...
# Print the names of recommended charms for this charm
for item in recommendations:
    idx, score = item
    print(pair_distances.componentA.loc[pair_distances.componentA_id == idx].iloc[0])
...
# Find the 20 most similar to cs:trusty/mongodb
item_id = 188 #cs:trusty/mongodb
n_similar = 20
...
for item in similar:
    idx, score = item
    print(pair_distances.componentB.loc[pair_distances.componentB_id == idx].iloc[1])

t = set(componentsA) & set(componentsB)
print(len(t))

print(pair_distances.loc[pair_distances['componentB_id'] == 188])
